...
interface AttributesLoaderContract
{
     ...
     *
     * @param class-string<TAttribute>           $attribute    The name of the attribute to load.
     * @param LoadType                           $type         The type of loading mechanism to use.
     * @param bool                               $ascend       Whether to ascend the class hierarchy during loading.
     * @param Closure(Collection<class-string<TAttribute>, TAttribute|Collection<int, TAttribute>>): mixed|null $customLoader
     *     A custom loader function to handle the loading process.
     *
